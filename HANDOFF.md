...
## 8. 🎯 Próximo passo
**#85 fase 3:** obra obrigatória em todos os tipos + `cidade_estado` obrigatório (migração `0047`, obra antiga sem o campo pede na hora e grava na obra). Backlog: export/backup, #29 (reatribuir demandas existentes), #43/#32/#18/#17/#16.
