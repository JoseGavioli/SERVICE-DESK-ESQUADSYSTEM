...
## 8. 🎯 Próximo passo
**#85 fase 2:** cliente e obra voltam para a tela de criação do Fechamento (hoje o cliente é escolhido DENTRO da ficha, §19). Decisão do dono: **fonte única** — saem da ficha e ficam só na tela de criação; dentro da ficha aparecem só para leitura. Depois, **fase 3**: obra obrigatória em todos os tipos + `cidade_estado` obrigatório (migração `0047`, obra antiga sem o campo pede na hora e grava na obra). Backlog: export/backup, #29 (reatribuir demandas existentes), #43/#32/#18/#17/#16.
